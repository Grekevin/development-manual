* [JS Browser BOM](#js-browser-bom)
	* [JavaScript Window - 浏览器对象模型](#javascript-window-浏览器对象模型)
		* [浏览器对象模型（Browser Object Model (BOM)）](#浏览器对象模型browser-object-model-bom)
		* [Window 对象](#window-对象)
		* [窗口尺寸](#窗口尺寸)
		* [其他窗口方法](#其他窗口方法)
	* [JavaScript Window Screen](#javascript-window-screen)
		* [Window Screen](#window-screen)
		* [Window Screen 色深](#window-screen-色深)
	...
	* [JavaScript Window Navigator](#javascript-window-navigator)
		...
		* [浏览器是否在线？](#浏览器是否在线)
		* [Java 是否启用？](#java-是否启用)
	* [JavaScript 弹出框](#javascript-弹出框)
		* [警告框](#警告框)
		* [确认框](#确认框)
		* [提示框](#提示框)
		* [折行](#折行)
	* [JavaScript Timing 事件](#javascript-timing-事件)
		* [Timing 事件](#timing-事件)
	...
	* [JavaScript Cookies](#javascript-cookies)
		...
		* [通过 JavaScript 创建 cookie](#通过-javascript-创建-cookie)
		* [通过 JavaScript 读取 cookie](#通过-javascript-读取-cookie)
		* [通过 JavaScript 改变 cookie](#通过-javascript-改变-cookie)
		* [通过 JavaScript 删除 cookie](#通过-javascript-删除-cookie)
		* [Cookie 字符串](#cookie-字符串)
		* [JavaScript Cookie 实例](#javascript-cookie-实例)
		* [设置 cookie 的函数](#设置-cookie-的函数)
		* [获取 cookie 的函数](#获取-cookie-的函数)
		* [检测 cookie 的函数](#检测-cookie-的函数)
...
Cookie 是在您的计算机上存储的文本文件中的数据。

当 web 服务器向浏览器发送网页后，连接被关闭，服务器会忘记用户的一切。

Cookie 是为了解决“如何记住用户信息”而发明的：

 - 当用户访问网页时，用户的名字存储在 cookie 中。
 - 下次访问页面时，会带上这个cookie。
...
当浏览器从服务器请求一个网页时，将属于该页的 cookie 添加到该请求中。这样服务器就获得了必要的数据来“识别”用户。

如果浏览器已关闭本地 cookie 支持，则cookie作用就会失效。
