* [JS 对象](#js-对象)
	...
	* [JavaScript 对象属性](#javascript-对象属性)
		...
		* [属性值](#属性值)
		* [原型属性](#原型属性)
	* [JavaScript 对象方法](#javascript-对象方法)
		* [JavaScript 方法](#javascript-方法)
		* [this 关键词](#this-关键词)
		* [访问对象方法](#访问对象方法)
		* [使用内建方法](#使用内建方法)
		* [添加新的方法](#添加新的方法)
	* [JavaScript 对象访问器](#javascript-对象访问器)
		* [JavaScript 访问器（Getter 和 Setter）](#javascript-访问器getter-和-setter)
		* [JavaScript Getter（get 关键词）](#javascript-getterget-关键词)
		* [JavaScript Setter（set 关键词）](#javascript-setterset-关键词)
		* [JavaScript 函数还是 Getter？](#javascript-函数还是-getter)
		* [数据质量](#数据质量)
		* [为什么使用 Getter 和 Setter？](#为什么使用-getter-和-setter)
		* [一个计数器实例](#一个计数器实例)
	* [JavaScript 对象构造器](#javascript-对象构造器)
		* [对象类型（蓝图）（类）](#对象类型蓝图类)
		* [this 关键词](#this-关键词)
		* [为对象添加属性](#为对象添加属性)
		* [为对象添加方法](#为对象添加方法)
		* [为构造器添加属性](#为构造器添加属性)
		* [为构造器添加方法](#为构造器添加方法)
		* [内建 JavaScript 构造器](#内建-javascript-构造器)
		* [多用字面量，少用new](#多用字面量少用new)
	* [JavaScript 对象原型](#javascript-对象原型)
		* [原型继承](#原型继承)
		* [向对象添加属性和方法](#向对象添加属性和方法)
			* [使用 prototype 属性](#使用-prototype-属性)
		* [avaScript ES5 对象方法](#avascript-es5-对象方法)
			* [ES5 新的对象方法](#es5-新的对象方法)
			* [列出可枚举的属性](#列出可枚举的属性)
